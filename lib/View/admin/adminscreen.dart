...
import 'package:resturant/View/admin/adddocc.dart';
import 'package:resturant/View/component/adminwidget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      builder: (context, state) {
        ...
        return  (cubit.doctormodel?.informations??[] ).isEmpty ?Center(
      child: Column(
        children: [
              ...
              itemBuilder: (context, index) {
                return Material(
                    ...
                    child: InkWell(
                        ...
                        child: AdminWidget(
                          doctorinfo: cubit.doctormodel?.informations?[index],
                        )));
              },
